...
const Navigation = ({ onAlgorithmSelect, onMazeSelect, onClearGrid, onClearPath }) => {
            ...
            <div className="nav-container">
                ...
                <div className="nav-menu">
                    <div className="dropdown">
                        <button className="dropdown-toggle" onClick={toggleAlgorithmDropdown}>
                            Algorithms ▼
                        </button>
                        ...
                        {isMazeDropdownOpen && (
                            <ul className="dropdown-menu">
                                ...
                                <li>
                                    <button
                                        className="dropdown-item"
                                        onClick={() => handleMazeClick("horizontal-recursive-division")}
                                    >
                                ...
                                <li>
                                    <button
                                        className="dropdown-item"
                                        onClick={() => handleMazeClick("vertical-recursive-division")}
                                    >
